...
**PhD in Biological Sciences** -- University of Cambridge, UK (Oct 2019 -- expected Oct 2023)                    
...
Supervised by Sarah Teichmann and John Marioni. Comparative analysis of single-cell omics data.
...
**Dann E.**, Teichmann S.A., Marioni J.C. (2023) Precise identification of cell states altered in disease with healthy single-cell references, _Nature Genetics_ | [Full text](https://www.nature.com/articles/s41588-023-01523-7) | 
[code](https://github.com/MarioniLab/oor_design_reproducibility) | 
[python package](https://github.com/MarioniLab/oor_benchmark)

Botting R.A., Goh I., ... , **Dann E.**, ... , Teichmann S.A. , Haniffa M. (2022) Yolk sac cell atlas reveals multiorgan functions during human early development. _Science_ |
...
Apr 2021 - [Open Problems in Single-Cell Analysis Jamboree](https://openproblems.bio/jamboree/)  
