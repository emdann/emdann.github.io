...
`r fa("envelope", fill = '#710C0C')`  emmadann\@stanford.edu \ | \ `r fa("globe", fill = '#710C0C')` [emdann.github.io](https://emdann.github.io) \ | \ 
...
Hosted by Jonathan Pritchard and Alex Marson (visiting fellow at Gladstone Institutes)
